...
const Home = () => {
    ...
    return (
        <>
            ...
            <nav className="navbar" id='#Home'>
                ...
                <div className="menu">
                    ...
                    <a className='effect-1' href="">Projects</a>
                    <a className='effect-1' href="">Contact</a>
                    <a className='effect-1' href="/">
                        <a href="/"><button class="bn-32 bn32">Hire me</button></a>
                ...
                <div className="sec-4-container">
                    ...
                    <div className="sec-4-container-2">
                        <div className="sec-4-cnt-2">
                            <a href=""><img className='projects' src={require("../Assets/project-1.png")} alt="" /></a>
                            <a href="https://chowdaryram1.github.io/Beej-Project/"><img className='projects' src={require("../Assets/project-2.png")} alt="" /></a>
                            <a href=""><img className='projects' src={require("../Assets/project-3.png")} alt="" /></a>
                            <a href=""><img className='projects' src={require("../Assets/project-4.png")} alt="" /></a>
                            <a href=""><img className='projects' src={require("../Assets/bootstrap-projec-5.png")} alt="" /></a>
                            <a className='projects-imgs' href=""><img className='projects' src={require("../Assets/project-6.png")} alt="" /></a>
                        </div>
                    </div>
                </div>
            </section>
     ...
     data-aos-duration="4000">
          ...
          <span>--- </span>  <p>  Copyrights © 2022 All rights reserved by Rammohan     </p><span>---</span>
          </div>
